...
exrLoader.load("/hdri/studio.exr", (texture) => {
  ...
  /* fondo blanco limpio tipo estudio */
  scene.background = new THREE.Color(0xffffff);

  /* control de reflejos */
  scene.environmentIntensity = 1.4;

  /* rotación del HDRI (ajusta iluminación del estudio) */
...
window.addEventListener("wheel", (e) => {
  ...
  cameraRig.radius = THREE.MathUtils.clamp(cameraRig.radius, 1, 50);
});
